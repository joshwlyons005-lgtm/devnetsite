...
- **Social previews**: [`assets/og-image.png`](assets/og-image.png) is referenced by Open Graph and Twitter meta tags (e.g. `https://vcbn.ca/assets/og-image.png`). Keep this file in sync when deploying so link previews work.
